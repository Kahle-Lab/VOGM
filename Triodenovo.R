## Author: Xue Zeng (Modified by Shujuan Zhao)
## Latest modified date: 07-26-21
...
#command1=paste("java -Xmx64g -jar /home/wd256/programs/GenomeAnalysisTK-3.7/GenomeAnalysisTK.jar -nt 16 -R /home/bioinfo/software/knightlab/genomes/hs37d5/human_g1k_v37_decoy.fasta -T SelectVariants --variant ",Input," -o Trio_",Familyno,".vcf -env -sn ",Proband_ID," -sn ",Father_ID," -sn ",Mother_ID,sep="")
#system(command1,intern=F)

command1=paste("java -Xmx64g -jar /gpfs/ycga/home/sz463/programs/GenomeAnalysisTK-3.8/GenomeAnalysisTK.jar -nt 16 -R /home/bioinfo/software/knightlab/genomes/hs37d5/human_g1k_v37_decoy.fasta -T SelectVariants --variant ",Input," -o Trio_",Familyno,".vcf -env -sn ",Proband_ID," -sn ",Father_ID," -sn ",Mother_ID,sep="")
system(command1,intern=F)

#command1=paste("java -Xmx64g -jar /gpfs/ycga/home/ga352/programs/GenomeAnalysisTK-3.7/GenomeAnalysisTK.jar -nt 16 -R /gpfs/ycga/home/sj483/Ref_Data/Public_Files/b37/human_g1k_v37.fasta -T SelectVariants --variant ",Input," -o Trio_",Familyno,".vcf -env -sn ",Proband_ID," -sn ",Father_ID," -sn ",Mother_ID,sep="")
#system(command1,intern=F)

#command1=paste("java -Xmx64g -jar /gpfs/ycga/home/ga352/programs/GenomeAnalysisTK-3.7/GenomeAnalysisTK.jar -nt 16 -R /gpfs/ycga//home/bioinfo/software/knightlab/genomes/hs37d5/human_g1k_v37_decoy.fasta -T SelectVariants --variant ",Input," -o Trio_",Familyno,".vcf -env -sn ",Proband_ID," -sn ",Father_ID," -sn ",Mother_ID,sep="")
#system(command1,intern=F)

##Regenotype
system(paste('java -Xmx64g -jar /gpfs/ycga/home/sz463/programs/GenomeAnalysisTK-3.8/GenomeAnalysisTK.jar -nt 16 -R /home/bioinfo/software/knightlab/genomes/hs37d5/human_g1k_v37_decoy.fasta -T RegenotypeVariants --variant Trio_',Familyno,'.vcf -o Trio_',Familyno,'_reGT.vcf',sep = ''),intern = F)

#system(paste('java -Xmx64g -jar /home/wd256/programs/GenomeAnalysisTK-3.7/GenomeAnalysisTK.jar -nt 16 -R /home/bioinfo/software/knightlab/genomes/hs37d5/human_g1k_v37_decoy.fasta -T RegenotypeVariants --variant Trio_',Familyno,'.vcf -o Trio_',Familyno,'_reGT.vcf',sep = ''),intern = F)
...
system(paste("python /gpfs/ycga/home/sz463/Script/de_novo/ParseTrioVCF.py ",Familyno,sep = ""),intern = F)

##annovar annotate updated VCF file
#command7=paste("perl /home/wd256/programs/annovar/table_annovar.pl --vcfinput Trio_",Familyno,"_updated.vcf /home/wd256/project/programs/annovar/humandb/ -buildver hg19 -out Trio_",Familyno," -remove -protocol refGene,genomicSuperDups,snp138,dbnsfp33a,esp6500siv2_all,1000g2015aug_all,exac03,gnomad_exome,gnomad_genome -operation g,r,f,f,f,f,f,f,f -nastring '.'",sep = "")
#system(command7,intern=F)

#command7=paste("perl /gpfs/ycga/project/kahle/pf374/annovar_20191024/table_annovar.pl --vcfinput Trio_",Familyno,"_updated.vcf /gpfs/ycga/project/kahle/pf374/annovar_20191024/humandb/ -buildver hg19 -out Trio_",Familyno," -remove -protocol refGene,genomicSuperDups,snp138,1000g2015aug_all,avsnp150,exac03,exac03nontcga,gnomad_exome,gnomad_genome,gnomad211_exome,gnomad211_genome,dbnsfp41a,dbscsnv11,clinvar_20210123,bravo,mcap,revel -operation g,r,f,f,f,f,f,f,f,f,f,f,f,f,f,f,f -nastring '.'",sep = "")

#add mpc
command7=paste("perl /gpfs/ycga/project/kahle/pf374/annovar_20191024/table_annovar.pl --vcfinput Trio_",Familyno,"_updated.vcf /gpfs/ycga/scratch60/kahle/sz463/humandb -buildver hg19 -out Trio_",Familyno," -remove -protocol refGene,genomicSuperDups,snp138,dbnsfp33a,esp6500siv2_all,1000g2015aug_all,exac03,gnomad_exome,gnomad_genome,mpc -operation g,r,f,f,f,f,f,f,f,f -nastring '.'",sep = "")
system(command7,intern=F)

#/gpfs/ycga/home/ga352/programs/annovar/annotate_variation.pl
...
command6=paste("/gpfs/ycga/home/sz463/Script/de_novo/triodenovo.0.06/src/triodenovo --ped Trio_",Familyno,".ped --in_vcf Trio_",Familyno,"_updated.vcf --out Trio_",Familyno,".denovo.Bayfilter.vcf --mixed_vcf_records",sep = "")
...
system(paste("python /gpfs/ycga/home/sz463/Script/de_novo/PrepareMerge.py ",Familyno,sep = ""),intern = F)
